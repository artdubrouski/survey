...
def test_admin_can_delete_question(api_admin, survey_active):
...
def test_can_update_questions(api_admin, survey_active, question_type):
    api_admin.post('/api/v1/surveys/', data=survey_active)
...
def test_can_delete_question_from_survey(api_admin, survey_active):
    got = api_admin.post('/api/v1/surveys/', data=survey_active)
